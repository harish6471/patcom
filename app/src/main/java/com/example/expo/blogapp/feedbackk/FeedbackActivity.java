package com.example.expo.blogapp.feedbackk;
...
public class FeedbackActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        if (withInfo) {
            ...
            @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) CharSequence infoFeedbackEnd = getResources().getString(R.string.info_fedback_legal_will_be_sent, getAppLabel());
