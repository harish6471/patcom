...
public class PostActivitycrop1 extends AppCompatActivity {
       ...
       /* verifyCodeButton.setOnClickListener(new View.OnClickListener() {
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder show = new AlertDialog.Builder(PostActivitycrop1.this);
                show.setView(alertLayout);
                show.setCancelable(false);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(new Intent(PostActivitycrop1.this,MainActivity.class));
                        finish();
                    }
                },3000);
            }
...
// and add the transaction to the back stack so the user can navigate back
                        startActivity(new Intent(PostActivitycrop1.this, MainActivity.class));
                        finish();
                        Toast.makeText(PostActivitycrop1.this, "Post uploaded successfully :)", Toast.LENGTH_LONG).show();
                    }
                })
...
// and add the transaction to the back stack so the user can navigate back
                        ...
                        if (task.isSuccessful()) {
                           ...
                           // layout4.setVisibility(View.GONE);
                            ...
                            FirebaseUser currentUser = task.getResult().getUser();
                                ...
                                dialog_verifying.dismiss();
                                Toast.makeText(PostActivitycrop1.this,"Something wrong",Toast.LENGTH_SHORT).show();
  ...
  /*  private void uploadImage_10(){
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK)  // resultCode: -1
        {
            if (requestCode == CAMERA_REQUEST_CODE) // requestCode: 288
            {
                ...
                Toast.makeText(PostActivitycrop1.this, "Image 1 save",
                        Toast.LENGTH_SHORT).show();
            }
            if (requestCode == CAMERA_REQUEST_CODE1) {
                Uri picUri = mImageUri1;
                startCropImageActivity(picUri, RC_CROP1);
                Toast.makeText(PostActivitycrop1.this, "Image 2 save",
                        Toast.LENGTH_SHORT).show();
            }
    ...
    {
        if (currentStep == 0) {
            Intent i=new Intent(PostActivitycrop1.this,MainActivity.class);
            startActivity(i);
           // currentStep--;
         //   stepView.go(currentStep, true);
        } if (currentStep==1){
