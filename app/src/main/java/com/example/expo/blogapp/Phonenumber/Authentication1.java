package com.example.expo.blogapp.Phonenumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(phoneNumber)) {
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                            ...
                            Authentication1.this,               // Activity (for callback binding)
        ...
        mCallbacks =new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                ...
                AlertDialog.Builder show = new AlertDialog.Builder(Authentication1.this);
        ...
        verifyCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(verificationCode.isEmpty()){
                    Toast.makeText(Authentication1.this,"Enter verification code",Toast.LENGTH_SHORT).show();
                }else {
            ...
            public void onClick(View view) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(new Intent(Authentication1.this, MainActivity.class));
                        finish();
                    }
                },3000);
            }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            dialog_verifying.dismiss();
                            Toast.makeText(Authentication1.this,"Something wrong",Toast.LENGTH_SHORT).show();
