...
//                        Toast.makeText(AccounrSetup.this,"DATA EXISTS",Toast.LENGTH_LONG).show();
                        ...
                        Glide.with(UpdateActivity.this).setDefaultRequestOptions( placeHolder.placeholder(R.mipmap.user)).load(image).into(userImg);

                    }
                    else{
                        main_uri = default_uri;
                        Toast.makeText(UpdateActivity.this,"NO DATA EXISTS",Toast.LENGTH_LONG).show();
                    }
                }
                else{
                    Toast.makeText(UpdateActivity.this,"Firestore Retrieve Error OUTSIDE",Toast.LENGTH_LONG).show();
                }
            }
        });
...
//                    String user_id = mAuth.getCurrentUser().getUid();
                        ...
                        try {
                            compressedImageBitmap = new Compressor(UpdateActivity.this)
                                    .setMaxHeight(100)
                                    .setMaxWidth(100)
                                    .setQuality(10)
...
//
                        ...
                        Toast.makeText(UpdateActivity.this, "No image", Toast.LENGTH_LONG).show();
                        progressBar.setVisibility(View.INVISIBLE);
                    }
                }
                else {
                    Toast.makeText(UpdateActivity.this, "Image not changed", Toast.LENGTH_LONG).show();
        ...
        userImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    Toast.makeText(UpdateActivity.this, "ReadPerm", Toast.LENGTH_LONG).show();
...
//                        ActivityCompat.requestPermissions(AccounrSetup.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    ...
                    Toast.makeText(UpdateActivity.this, "WritePerm", Toast.LENGTH_LONG).show();
...
//                    ActivityCompat.requestPermissions(AccounrSetup.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},1);
                        ActivityCompat.requestPermissions(UpdateActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 2);
            ...
            private void getPicture() {
                Toast.makeText(UpdateActivity.this,"Successfully Saved",Toast.LENGTH_LONG).show();
                CropImage.activity()
    ...
    private void saveToFirestore(final Task<UploadTask.TaskSnapshot> task, final String uName) {
      // final UploadTask.TaskSnapshot[] downloadUri = new UploadTask.TaskSnapshot[1];
        Uri downloadUri;
       ...
       // userMap.put("image",downloadUri.toString());
        fireStore.collection("Users").document(user_id).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(UpdateActivity.this, "Settings Saved Succesfully", Toast.LENGTH_LONG).show();
