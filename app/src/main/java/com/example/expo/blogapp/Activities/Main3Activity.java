...
import com.example.expo.blogapp.interfaces.OtpReceivedInterface;
import com.example.expo.blogapp.receiver.SmsBroadcastReceiver;
    ...
    public void startSMSListener() {
        ...
        mTask.addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(Main3Activity.this, "SMS Retriever starts", Toast.LENGTH_LONG).show();
            }
        });
